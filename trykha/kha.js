...
$hxClasses["Interp"] = Interp;
Interp.__name__ = true;
Interp.__super__ = hscript_Interp;
Interp.prototype = $extend(hscript_Interp.prototype,{
	get: function(o,f) {
...
Main.__name__ = true;
Main.main = function() {
	kha_System.init("TryKha",640,480,Main.init);
};
Main.init = function() {
	var game = new Empty();
...
var Script = function(script) {
	...
	this.interp.variables.set("System",kha_System);
...
var kha_Button = $hxClasses["kha.Button"] = { __ename__ : true, __constructs__ : ["NONE","UP","RIGHT","DOWN","LEFT","BUTTON_1","BUTTON_2"] };
...
var kha_graphics4_VertexData = $hxClasses["kha.graphics4.VertexData"] = { __ename__ : true, __constructs__ : ["Float1","Float2","Float3","Float4"] };
