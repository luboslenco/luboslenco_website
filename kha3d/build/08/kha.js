...
Empty.__super__ = kha_Game;
Empty.prototype = $extend(kha_Game.prototype,{
	init: function() {
	...
	,loadingFinished: function() {
		...
		structure.add("vertexUV",kha_graphics4_VertexData.Float2);
		...
		this.viewMatrixID = this.program.getConstantLocation("V");
		this.modelMatrixID = this.program.getConstantLocation("M");
		this.lightID = this.program.getConstantLocation("lightPos");
		...
		var obj = new ObjLoader(kha_Loader.the.getBlob("suzanne").toString());
		var data = obj.data;
	...
	,render: function(frame) {
		...
		g.setProgram(this.program);
		g.setMatrix(this.matrixID,this.mvp);
		g.setMatrix(this.modelMatrixID,this.model);
		g.setMatrix(this.viewMatrixID,this.view);
		var lightPos = new kha_math_Vector3(4,4,4);
		g.setFloat3(this.lightID,lightPos.x,lightPos.y,lightPos.z);
