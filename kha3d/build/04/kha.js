...
Empty.prototype = $extend(kha_Game.prototype,{
	init: function() {
		...
		while(_g1 < _g) {
			var i = _g1++;
			vbData[i * 6] = Empty.vertices[i * 3];
			vbData[i * 6 + 1] = Empty.vertices[i * 3 + 1];
			vbData[i * 6 + 2] = Empty.vertices[i * 3 + 2];
			vbData[i * 6 + 3] = Empty.colors[i * 3];
			vbData[i * 6 + 4] = Empty.colors[i * 3 + 1];
			vbData[i * 6 + 5] = Empty.colors[i * 3 + 2];
		}
