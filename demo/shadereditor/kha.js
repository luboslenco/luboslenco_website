...
$hxClasses["luegame.NodeRotator"] = luegame_NodeRotator;
luegame_NodeRotator.__name__ = ["luegame","NodeRotator"];
luegame_NodeRotator.__super__ = lue_trait_Trait;
luegame_NodeRotator.prototype = $extend(lue_trait_Trait.prototype,{
	update: function() {
		this.rotZ += lue_sys_Time.delta / 2;
		lue_Eg.setNodeTransform(this.node,0,0,0,0,0,this.rotZ);
	}
	,__class__: luegame_NodeRotator
});
var luegame_Game = function() {
	var modelRes = lue_resource_Resource.getModel("monkey_resource","");
