...
Main.start = function() {
	kha_System.init("CyclesGame",1136,640,function() {
...
lue_node_Node.addScene = function(name,parent) {
	...
	lue_node_Node.traverseNodes(name,parent,resource.nodes);
	return parent;
};
lue_node_Node.traverseNodes = function(name,parent,nodes) {
	var _g = 0;
	while(_g < nodes.length) {
		...
		if(n.type == "camera_node") node = lue_Eg.addCameraNode(lue_resource_Resource.getCamera(name,n.object_ref),parent); else if(n.type == "light_node") node = lue_Eg.addLightNode(lue_resource_Resource.getLight(name,n.object_ref),parent); else if(n.type == "geometry_node") {
			...
			node = lue_Eg.addModelNode(lue_resource_Resource.getModel(object_file,object_ref),materials,parent);
		...
		if(node != null) {
			...
			lue_node_Node.traverseNodes(name,node,n.nodes);
		}
	}
};
...
lue_resource_Resource.getModel = function(name,id) {
	var cached = lue_resource_Resource.cachedModels.get(name + id);
	if(cached == null) {
		var parsed = lue_resource_ModelResource.parse(name,id);
...
var lue_resource_ModelResource = function(resource) {
	...
	this.buildData(data,pa,uva,na,ca,tana,bitana,null,null);
	...
	var struct = lue_resource_ShaderResource.getVertexStructure(pa != null,uva != null,na != null,ca != null,tana != null,bitana != null);
	var structLength = lue_resource_ShaderResource.getVertexStructureLength(pa != null,uva != null,na != null,ca != null,tana != null,bitana != null);
	this.geometry = new lue_resource_Geometry(data,indices,materialIndices,pa,uva,na,ca,tana,bitana,usage);
...
lue_resource_ModelResource.parse = function(name,id) {
	var format = lue_resource_Resource.getSceneResource(name);
	...
	if(resource.mesh.skin != null) {
		var _g = 0;
		var _g1 = format.nodes;
		while(_g < _g1.length) {
			var n = _g1[_g];
			++_g;
			lue_resource_ModelResource.setParents(n);
		}
		lue_resource_ModelResource.traverseNodes(format,function(node) {
...
lue_resource_ModelResource.traverseNodes = function(data,callback) {
	var _g1 = 0;
	var _g = data.nodes.length;
	while(_g1 < _g) {
		var i = _g1++;
		lue_resource_ModelResource.traverseNodesStep(data.nodes[i],callback);
	}
};
...
lue_resource_ModelResource.prototype = $extend(lue_resource_Resource.prototype,{
	...
	,buildData: function(data,pa,uva,na,ca,tana,bitana,ba,wa) {
		var _g1 = 0;
...
var lue_resource_Geometry = function(data,indices,materialIndices,positions,uvs,normals,cols,tangents,bitangents,usage) {
...
lue_resource_ShaderResource.getVertexStructure = function(pos,tex,nor,col,tan,bitan) {
...
lue_resource_ShaderResource.getVertexStructureLength = function(pos,tex,nor,col,tan,bitan) {
	if(bitan == null) bitan = false;
	if(tan == null) tan = false;
	if(col == null) col = false;
	if(nor == null) nor = false;
...
var myproject_ArcBall = function() {
	lue_trait_Trait.call(this);
	this.origin = new lue_math_Vec3();
	this.requestInit($bind(this,this.init));
	this.requestUpdate($bind(this,this.update));
};
$hxClasses["myproject.ArcBall"] = myproject_ArcBall;
myproject_ArcBall.__name__ = ["myproject","ArcBall"];
myproject_ArcBall.__super__ = lue_trait_Trait;
myproject_ArcBall.prototype = $extend(lue_trait_Trait.prototype,{
	camera: null
	,origin: null
	,pitchRad: null
	,init: function() {
	...
	,__class__: myproject_ArcBall
});
var myproject_FlyCamera = function() {
...
$hxClasses["myproject.FlyCamera"] = myproject_FlyCamera;
myproject_FlyCamera.__name__ = ["myproject","FlyCamera"];
myproject_FlyCamera.__super__ = lue_trait_Trait;
myproject_FlyCamera.prototype = $extend(lue_trait_Trait.prototype,{
	camera: null
	,pitchRad: null
	,moveForward: null
	,moveBackward: null
	...
	,__class__: myproject_FlyCamera
});
var myproject_NodeTree = function() {
	cycles_trait_NodeExecutor.call(this);
	this.requestAdd($bind(this,this.add));
};
$hxClasses["myproject.NodeTree"] = myproject_NodeTree;
myproject_NodeTree.__name__ = ["myproject","NodeTree"];
myproject_NodeTree.__super__ = cycles_trait_NodeExecutor;
myproject_NodeTree.prototype = $extend(cycles_trait_NodeExecutor.prototype,{
	add: function() {
...
kha_Shaders.blender_Instancing_vertData = "s1855:";
